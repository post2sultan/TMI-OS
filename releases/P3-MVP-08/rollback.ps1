...
$backupRoot = Join-Path $Root "releases\P3-MVP-08\backups"
...
if ($backup -and (Test-Path -LiteralPath $backup)) {
    ...
    Write-Host "P3-MVP-08 rollback restored the latest encrypted vault backup."
} else {
    Write-Host "P3-MVP-08 rollback: no prior encrypted vault backup was present."
}
