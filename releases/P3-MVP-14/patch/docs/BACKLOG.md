...
Status: Complete — delivered by P3-MVP-01
...
Status: Complete — delivered by P3-MVP-01 and P3-MVP-04
...
Status: Complete — delivered by P3-MVP-02A using local Kokoro
...
Status: Complete — delivered by P3-MVP-02 and P3-MVP-04
...
Status: Complete — explicit owner confirmation is enforced

### Supported Launch Channels

- YouTube video and Shorts: private upload, owner makes public after review
- Instagram Reel: public only after explicit owner approval
- Instagram Story: public only after explicit owner approval
- TikTok: draft upload to the owner's Inbox for final posting

Status: Complete and runtime validated

### Deferred — LinkedIn Page Publishing

LinkedIn Page publishing requires LinkedIn Community Management API access and
the `w_organization_social` permission. The current credentials authorize only
a personal profile, so publishing is blocked by an organization-only safety
guard. Revisit after LinkedIn approves Page-level product access.

Status: Deferred by owner on 2026-08-03

### NEXT — P3-MVP-14 Final Launch Acceptance

Run one fresh campaign through discovery, analysis, review, approval, content
generation, channel rendering, and the supported publishing paths. Public
publishing still requires explicit owner approval per channel.
