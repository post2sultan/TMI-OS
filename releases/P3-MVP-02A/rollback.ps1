...
docker compose --env-file $EnvFile --project-name tmi-production -f $ComposeFile run --rm backend alembic downgrade f8c2e4a6b0d3
...
Write-Host "P3-MVP-02A rollback PASSED."
