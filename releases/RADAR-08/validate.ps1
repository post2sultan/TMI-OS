...
if (-not $SourceOnly) {
    ...
    $web = Invoke-WebRequest -UseBasicParsing -Uri "http://127.0.0.1:5173/campaign-radar" -TimeoutSec 30
    if ($web.StatusCode -ne 200) { throw "Radar command center is not reachable." }
