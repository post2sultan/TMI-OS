...
from app.services.evidence_confidence import (
    EvidenceConfidenceAssessor,
    evidence_confidence_assessor,
)
...
class CampaignDocumentRepository:
    ...
    def __init__(
        ...
        confidence_assessor: EvidenceConfidenceAssessor = (
            evidence_confidence_assessor
        ),
    ) -> None:
    ...
    def apply_extraction(
        ...
        *,
        ...
        document.evidence_origin = confidence.origin
        document.confidence_score = confidence.score
        document.evidence_representation = confidence.representation
        document.supporting_source = confidence.supporting_source
        session.add(document)
        session.flush()
        return document
