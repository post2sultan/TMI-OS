...
$BackendBackup = "tmi-os-backend:pre-p3-mvp-03-$Stamp"
$FrontendBackup = "tmi-os-frontend:pre-p3-mvp-03-$Stamp"
...
$DbBackupName = "p3-mvp-03-$Stamp.sql"
...
try {
    ...
    Write-Host "P3-MVP-03 installation PASSED."
}
catch {
    docker compose --env-file $EnvFile --project-name tmi-production -f $ComposeFile run --rm backend alembic downgrade a9d3f5b7c1e4 | Out-Null
