...
docker compose --env-file $EnvFile --project-name tmi-production -f $ComposeFile run --rm backend alembic downgrade a9d3f5b7c1e4
...
Write-Host "P3-MVP-03 rollback PASSED."
