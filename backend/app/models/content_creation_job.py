...
class ContentCreationJob(Base):
    ...
    linkedin_status: Mapped[str] = mapped_column(String(30), nullable=False, default="not_queued", server_default="not_queued")
    linkedin_post_urn: Mapped[str] = mapped_column(String(160), nullable=False, default="", server_default="")
    linkedin_video_urn: Mapped[str] = mapped_column(String(160), nullable=False, default="", server_default="")
    linkedin_error: Mapped[str] = mapped_column(Text, nullable=False, default="", server_default="")
    linkedin_attempts: Mapped[int] = mapped_column(Integer, nullable=False, default=0, server_default="0")
    linkedin_requested_at: Mapped[datetime | None] = mapped_column(DateTime(timezone=True), nullable=True)
